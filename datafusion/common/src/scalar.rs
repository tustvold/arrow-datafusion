...
impl ScalarValue {
    ...
    pub fn add<T: Borrow<ScalarValue>>(&self, other: T) -> Result<ScalarValue> {
        ...
        let rhs = other.borrow().to_array();
        let result =
            add_wrapping(&Scalar::new(lhs.as_ref()), &Scalar::new(rhs.as_ref()))?;
    ...
    pub fn add_checked<T: Borrow<ScalarValue>>(&self, other: T) -> Result<ScalarValue> {
        let lhs = self.to_array();
        let rhs = other.borrow().to_array();
        let result = add(&Scalar::new(lhs.as_ref()), &Scalar::new(rhs.as_ref()))?;
        ScalarValue::try_from_array(result.as_ref(), 0)
    }
    ...
    pub fn sub<T: Borrow<ScalarValue>>(&self, other: T) -> Result<ScalarValue> {
        ...
        let rhs = other.borrow().to_array();
        let result =
            sub_wrapping(&Scalar::new(lhs.as_ref()), &Scalar::new(rhs.as_ref()))?;
        ScalarValue::try_from_array(result.as_ref(), 0)
    }
    ...
    pub fn sub_checked<T: Borrow<ScalarValue>>(&self, other: T) -> Result<ScalarValue> {
        let lhs = self.to_array();
        let rhs = other.borrow().to_array();
        let result = sub(&Scalar::new(lhs.as_ref()), &Scalar::new(rhs.as_ref()))?;
        ScalarValue::try_from_array(result.as_ref(), 0)
    }
