...
use datafusion_data_access::SizedFile;
...
mod tests {
    ...
    use crate::datasource::listing::{local_unpartitioned_file, FileRange};
    use crate::physical_plan::collect;
    use crate::prelude::{
        CsvReadOptions, ParquetReadOptions, SessionConfig, SessionContext,
    };
    use crate::{assert_batches_sorted_eq, assert_contains};
    ...
    async fn round_trip_to_parquet(
        ...
        let parquet_exec = make_exec(&files, projection, schema, predicate).await;
